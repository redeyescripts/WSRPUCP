...
<html lang="en">
<head>
    <!-- Copyright 2024 by Hedge Studio -->
    <meta charset="UTF-8">
        ...
        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
          ...
          <nav class="mt-1 px-2 space-y-1 bg-[#263c66] rounded-xl">
            ...
            <a x-show="currentGame === 'gtav'" @click="sidebarOpen = false; setPageNew('status', '');" class="text-zinc-300 hover:bg-sky-950 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded text-white">
              <svg class="text-zinc-300 mr-2 h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path opacity="0.4" d="M6.87988 18.1501V16.0801" stroke="#f2f2f2" stroke-width="1.5" stroke-linecap="round"></path> <path opacity="0.4" d="M12 18.1498V14.0098" stroke="#f2f2f2" stroke-width="1.5" stroke-linecap="round"></path> <path opacity="0.4" d="M17.1201 18.1502V11.9302" stroke="#f2f2f2" stroke-width="1.5" stroke-linecap="round"></path> <g opacity="0.4"> <path d="M17.1199 5.84961L16.6599 6.38961C14.1099 9.36961 10.6899 11.4796 6.87988 12.4296" stroke="#f2f2f2" stroke-width="1.5" stroke-linecap="round"></path> <path d="M14.1904 5.84961H17.1204V8.76961" stroke="#f2f2f2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g> <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" stroke="#f2f2f2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
              Serveri Staatus 
            </a>
            <a x-show="currentGame === 'gtav'" href="https://cfx.re/join/mg7j9v" class="text-zinc-300 hover:bg-sky-950 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded text-white">
