...
<div x-data="{show: true}"><button onclick="location.href=`fivem://connect/cfx.re/join/doxkdj/'" class="bg-sky-700 hover:bg-sky-800 px-4 text-white h-10 shadow rounded cursor-pointer ml-[33%] md:ml-[43.5%]">Liitu serveriga</button></div>
<br>
<div id="items" class="md:gap-1 items-center ml-auto md:ml-[40%]">
    <div id="characters" class="md:w-9/12 mb-1 md:mb-0"></div>
    <iframe class="w-96 mr-20 md:mr-20 md:w-[25%] h-96 shadow mb-1" src="https://discord.com/widget?id=1028267959820496916&theme=dark" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
    <div class="md:w-3/12 mb-1 md:mb-0 ">
      
      <div class="shadow overflow-y-hidden overflow-x-auto rounded mb-1">
        <table class="min-w-full divide-y bg-stone-300 text-zinc-700">
          <h1 class="pb-5 text-2xl font-semibold text-white text-center underline">Edetabel</h1>
          ...
          <tbody class="bg-white divide-y divide-zinc-200">
            ...
            if ($result) {
                echo '<tbody class="bg-white divide-y divide-zinc-200">';
...
<div id="items" class="md:gap-1 ml-auto md:ml-[30%]">
    ...
    <div class="md:w-[50%] mb-1 md:mb-0">
      <div class="shadow overflow-y-hidden overflow-x-auto rounded mb-1">
        <table class="min-w-full divide-y bg-stone-300 text-zinc-700">
          <h1 class="pb-5 text-2xl font-semibold text-white text-center underline">Autod</h1>
          <thead class="bg-stone-300">
            <tr>
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">NIMI</th>
